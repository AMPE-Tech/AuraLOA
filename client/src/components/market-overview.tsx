  ...
  return (
    <section id="overview" className="py-10 md:py-16 border-t border-slate-700/30">
      <div className="max-w-[1400px] mx-auto px-4 sm:px-6">
              ...
              <div className="relative">
                ...
                <p className="text-lg font-bold text-slate-100 font-mono">
                  ...
                  {"suffix" in kpi && kpi.suffix && (
                    <span className={`text-sm ${"suffixColor" in kpi ? (kpi as { suffixColor: string }).suffixColor : ""}`}>{kpi.suffix}</span>
                  )}
                </p>
        ...
        {/* Linha 2: Barras esfera (progress) + Projeção LOA SVG */}
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-3">
          ...
          {/* Projeção LOA — barras agrupadas + linhas de tendência SVG */}
